...
"border:3px solid black;"));
        ...
        pushButton_13->setGeometry(QRect(130, 210, 91, 41));
        pushButton_13->setStyleSheet(QString::fromUtf8("border-radius:20px;\n"
"border:3px solid black;"));
        pushButton_10 = new QPushButton(keypad);
        pushButton_10->setObjectName(QString::fromUtf8("pushButton_10"));
        pushButton_10->setGeometry(QRect(130, 150, 91, 41));
...
"border:3px solid black;"));
        ...
        pushButton_15->setGeometry(QRect(360, 180, 91, 71));
        pushButton_15->setStyleSheet(QString::fromUtf8("border-radius:20px;\n"
"border:3px solid black;"));
...
"border:3px solid black;"));
    ...
    void retranslateUi(QWidget *keypad)
    {
        ...
        pushButton_9->setText(QCoreApplication::translate("keypad", "0", nullptr));
